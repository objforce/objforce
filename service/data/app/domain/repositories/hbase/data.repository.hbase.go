...
func (r *dataRepository) Get(c context.Context, orgId string, objId string, guid string, fields []string) (*models.MTData, error) {
	tableName := ObjId
	rowkey := guid
 ...
 * 获取多条记录
 */
func (r *dataRepository) MultiGet(c context.Context, orgId string, objId string, ids []string, fields []string) []*models.MTData {
