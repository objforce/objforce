...
func (s *customObjectService) Retrieve(c context.Context, objId string) (*models.CustomObject, error) {
...
func (s *customObjectService) FindByObjName(c context.Context, orgId, objName string) (*models.CustomObject, error) {
	entity, err := s.customObjectRepository.FindByObjName(c, orgId, objName)
	if err != nil {
		return nil, err
	}
...
func (s *CustomObjectServiceEventWrapper) Retrieve(c context.Context, id string) (*models.CustomObject, error) {
	return s.ref.Retrieve(c, id)
}
func (s *CustomObjectServiceEventWrapper) Delete(c context.Context, id string) error {
	model, err := s.ref.Retrieve(c, id)
	if err != nil {
		return err
	}
