...
type CustomObject struct {
	ObjId                      string            `json:"objId,emitempty"`
	OrgId                      string            `json:"orgId,emitempty"`
	ObjName                    string            `json:"objName,emitempty"`
...
func (o *CustomObject) FieldMap() map[string]*CustomField {
	// TODO 存储的约束
	var fieldMap map[string]*CustomField
