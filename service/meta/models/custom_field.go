...
type CustomField struct {
	...
	Deprecated          bool             `json:"deprecated,omitempty"`    // 是否保留使用
	Description         string           `json:"description,omitempty"`   // 字段描述
	DisplayFormat       string           `json:"displayFormat,omitempty"` // 展示格式
	Encrypted           bool             `json:"encrypted,omitempty"`     // 字段是否加密
	EncryptionScheme    EncryptionScheme `json:"encryptionScheme,omitempty"`
	External            bool             `json:"external,omitempty"`            // 表明是否一个外部映射列
	ExternalColumnName  string           `json:"externalColumnName,omitempty"`  // 对应的外部数据源 的 列名
	Formula             string           `json:"formula,omitempty"`             // 应用在字段上的公式
	FormulaTreatBlankAs TreatBlanksAs    `json:"formulaTreatBlankAs,omitempty"` // 如何处理空格
	InlineHelpText      string           `json:"inlineHelpText,omitempty"`      // 字段的帮助提示
	IsFilteringDisabled bool             `json:"isFilteringDisabled,omitempty"` // Available only for external objects. Indicates whether the custom field is available in filters
	...
	*/
	MetadataRelationshipControllingField string `json:"metadataRelationship​ControllingField,omitempty"`
	...
	*/
	...
	SecurityClassification SecurityClassification `json:"securityClassification,omitempty"`
	...
	*/
	SummaryOperation SummaryOperation `json:"summaryOperation,omitempty"`
	...
	*/
	VisibleLines int `json:"visibleLines,omitempty"`
